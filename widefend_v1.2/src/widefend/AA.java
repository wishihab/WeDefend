...
public class AA extends javax.swing.JFrame {
    AESlogic aesAlgo;
    private final byte[] keyValue = new byte[]{'W', 'i', 'D', 'e', 'F', 'e', 'N', 'd', 'e', 'R', 'S', 'e', 'c', 'R', 'e', 't'};
    public AA() {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/aes256bit.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {String plainText = jtText.getText();String encryptedText = aesAlgo.encrypt(plainText);jtResult.setText(encryptedText); 
        } catch (Exception e) {}
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {String encryptedText = jtResult.getText(); String plainText = aesAlgo.decrypt(encryptedText);jtResult.setText(plainText);
        }catch (Exception e) {}
